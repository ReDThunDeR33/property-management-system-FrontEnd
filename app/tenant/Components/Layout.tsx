...
const navItems = [
  ...
  { href: "/tenant/property", label: "My Property" },
  { href: "/tenant/payments", label: "Payments" },
  { href: "/tenant/issues", label: "Issues" },
  // { href: "/tenant/work-orders", label: "Work Orders" },
      ...
      <header className="h-20 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 lg:px-10 flex-shrink-0 sticky top-0 z-20">
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          >
            ...
            <span className="absolute top-0 right-0 w-2 h-2 bg-[#FF5A3D] rounded-full animate-pulse" />
          </button>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-gray-800 pb-16">
          <div className="md:col-span-2">
            ...
            <p className="text-sm max-w-sm leading-relaxed text-gray-500">
              View your property, manage payments,
              report issues, and track maintenance work
              orders — all from a single tenant dashboard.
            </p>
          </div>
